...
const TambahMekanik = (props) => {
  ...
  return (
    <div>
      <Row>
        <Breadcrumbs icon={icon} name="Mekanik" activeName="Tambah Mekanik" url="/mekanik" />
      </Row>
      <div className={styles.card}>
        <div className={styles.header}>
          ...
          <div className={styles.title}>TAMBAH MEKANIK</div>
        </div>
        <Form>
        ...
        <div className="d-flex">
          <div className={styles.button}>
            ...
            <Button className={styles.tambahTransaksi}>Tambah Mekanik</Button>
          </div>
        </div>
      </div>
    </div>
